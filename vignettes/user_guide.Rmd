...
param2 <- BatchtoolsParam(workers=4, cluster="sge", template=template)
results <- bplapply(letters[1:4], test, BPPARAM = param2, m = 1)

regArgs <- batchtoolsRegistryargs(packages = "Rcwl")
param3 <- BatchtoolsParam(workers=4, cluster="sge", template=template, registryargs = regArgs)
results <- bplapply(letters[1:4], testRun, BPPARAM = param3, cwl=echo)
